...
<head>
    ...
    <link href="/fresh/css/tiny-slider.css" rel="stylesheet" />
    <link href="/fresh/css/slick.css" rel="stylesheet" />
    <link href="/fresh/css/slick-theme.css" rel="stylesheet" />
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/x-icon" href="/fresh/images/favicon.ico" />
    <!-- <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> -->
    <!-- Libs CSS -->
    <link href="/fresh/css/bootstrap-icons.min.css" rel="stylesheet" />
    <link href="/fresh/css/feather-icons.css" rel="stylesheet" />
    <link href="/fresh/css/simplebar.min.css" rel="stylesheet" />

    <!-- Theme CSS -->
    <link rel="stylesheet" href="/fresh/css/theme.min.css" />
...
<body>
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="d-flex align-items-center">
                        <a class="navbar-brand d-none d-lg-block" href="../index.html">
                            <img src="/fresh/images/freshcart-logo.svg" alt="eCommerce HTML Template" />
                        </a>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item px-0 py-3">
                                                    <div class="row align-items-center g-0">
                                                        <div class="col-lg-3 col-3 text-center">
                                                            <!-- img -->
                                                            <img src="/fresh/images/product-img-1.jpg" alt="Ecommerce" class="icon-xxl" />
                                                        </div>
                                                ...
                                                <li class="list-group-item px-0 py-3">
                                                    <div class="row align-items-center g-0">
                                                        <div class="col-lg-3 col-3 text-center">
                                                            <!-- img -->
                                                            <img src="/fresh/images/product-img-2.jpg" alt="Ecommerce" class="icon-xxl" />
                                                        </div>
                                                        <div class="col-lg-7 col-7">
                                                            <!-- title -->
                                                            <a href="../pages/shop-single.html" class="text-inherit">
                                                ...
                                                <li class="list-group-item px-0 py-3">
                                                    <div class="row align-items-center g-0">
                                                        <div class="col-lg-3 col-3 text-center">
                                                            <!-- img -->
                                                            <img src="/fresh/images/product-img-3.jpg" alt="Ecommerce" class="icon-xxl" />
                                                        </div>
                                                        <div class="col-lg-7 col-7">
                                                            <!-- title -->
                                                            <a href="../pages/shop-single.html" class="text-inherit">
        ...
        <div class="container">
            <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
                <div class="offcanvas-header pb-1">
                    <a href="./index.html"><img src="/fresh/images/freshcart-logo.svg" alt="eCommerce HTML Template" /></a>
                    ...
                    <div>
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item dropdown dropdown-fullwidth">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Tekstil</a>
                                    ...
                                    <div class="row p-2 p-lg-4">
                                        ...
                                        <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                            <div class="card border-0">
                                                <img src="/fresh/images/menu-banner.jpg" alt="eCommerce HTML Template" class="img-fluid" />
                            ...
                            <li class="nav-item dropdown dropdown-fullwidth">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Elektronik</a>
                                <div class="dropdown-menu pb-0">
                                    <div class="row p-2 p-lg-4">
                                        <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                            <h6 class="text-primary ps-3">Dairy, Bread & Eggs</h6>
                            ...
                            <li class="nav-item dropdown dropdown-fullwidth">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Mobilya</a>
                                <div class="dropdown-menu pb-0">
                                    <div class="row p-2 p-lg-4">
                                        <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                            <h6 class="text-primary ps-3">Dairy, Bread & Eggs</h6>
                            ...
                            <li class="nav-item dropdown dropdown-fullwidth">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">İnşaat</a>
                                <div class="dropdown-menu pb-0">
                                    <div class="row p-2 p-lg-4">
                                        <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                            <h6 class="text-primary ps-3">Dairy, Bread & Eggs</h6>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="my-10 text-center">
                        <img src="/fresh/images/delivery-boy.svg" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <main>
        <!-- section -->
        <section class="py-lg-16 py-10" style="background: url(/fresh/images/banner-4.jpg) no-repeat; background-position: center; background-size: cover">
            <div class="container">
                <!-- row -->
                <div class="row">
        ...
        if (!isset($_GET['q']) || empty(trim($_GET['q']))) {
            $product_query = "SELECT p.*, (SELECT i.image FROM productimages i WHERE i.pid=p.id LIMIT 1) AS images FROM products p";
        } else {
            $product_query = "SELECT p.*, (SELECT i.image FROM productimages i WHERE i.pid=p.id LIMIT 1) AS images FROM products p 
        ...
        if ($stmt = mysqli_prepare($conn, $product_query)) {
            ...
            if (mysqli_num_rows($result) > 0) {
                // echo "row-cols-lg-4: Büyük ekranlarda (PC ve yukarısı) 4 sütun gösterilmesini sağlar.";
                // echo "row-cols-md-3: Orta ekranlarda (tablet ve benzeri cihazlar) 3 sütun gösterir.";
                // echo "row-cols-2: Küçük ekranlarda (mobil cihazlar) 2 sütun gösterir.";
        ?>
                                    ...
                                    <div class="card card-product mb-lg-4">
                                        <div class="card-body">
                                            ...
                                            <div class="text-center position-relative">
                                                ...
                                                <!-- img -->
                                                <!-- img -->
                                                <a href="#!"><img src="<?= $siteurl ?>/images/<?= $images ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                                <!-- action btn -->
                                                <!-- action btn -->
                                            ...
                                            <h2 class="fs-6"><a href="#!" class="text-inherit text-decoration-none"><?= $name ?></a></h2>
                                            <div>
                                                <!-- rating -->
                    ...
                    <div class="row flex-nowrap">
                        <div class="col">
                            <div class="card border-0 card-hover">
                                <a href="#" class="img-zoom"><img src="/fresh/images/ad-banner-4.jpg" alt="" class="rounded" /></a>
                        ...
                        <div class="col">
                            <div class="card border-0">
                                <a href="#" class="img-zoom"><img src="/fresh/images/ad-banner-5.jpg" alt="" class="rounded" /></a>
                        ...
                        <div class="col">
                            <div class="card border-0">
                                <a href="#" class="img-zoom"><img src="/fresh/images/ad-banner-6.jpg" alt="" class="rounded" /></a>
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            ...
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-1.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                                                <a href="#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                                            </div>
                                        </div>
                                        <!-- title -->
                            ...
                            <div class="item">
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-2.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                            ...
                            <div class="item">
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-3.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                            ...
                            <div class="item">
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-4.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            ...
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-5.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                            ...
                            <div class="item">
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-6.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                            ...
                            <div class="item">
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-8.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                            ...
                            <div class="item">
                                ...
                                <div class="card card-product h-100 mb-4">
                                    <div class="card-body position-relative">
                                        ...
                                        <div class="text-center position-relative">
                                            <!-- img -->
                                            <a href="#!"><img src="/fresh/images/product-img-9.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                                            <!-- action btn -->
                                            <div class="product-action-btn">
                                                <a href="#!" class="btn-action mb-1" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye"></i></a>
                                                <a href="../pages/shop-wishlist.html" class="btn-action mb-1" data-bs-toggle="tooltip" data-bs-html="true" title="Wishlist"><i class="bi bi-heart"></i></a>
                ...
                <div class="row row-cols-1 row-cols-lg-3 row-cols-md-3 g-4 g-lg-4">
                    ...
                    <div class="col">
                        ...
                        <div class="card p-6 card-product">
                            <div>
                                <!-- img -->
                                <img src="/fresh/images/stores-logo-1.svg" alt="" class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <div class="mt-4">
                                <!-- content -->
                    ...
                    <div class="col">
                        ...
                        <div class="card p-6 card-product">
                            <div>
                                <!-- img -->
                                <img src="/fresh/images/stores-logo-2.svg" alt="" class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <div class="mt-4">
                                <!-- content -->
                    ...
                    <div class="col">
                        ...
                        <div class="card p-6 card-product">
                            <div>
                                <!-- img -->
                                <img src="/fresh/images/stores-logo-3.svg" alt="" class="rounded-circle icon-shape icon-xl" />
                            </div>
                            <div class="mt-4">
                                <!-- content -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        <div class="mb-4">
                            <a href="#!">
                                <!-- img -->
                                <div class="img-zoom">
                                    <img src="/fresh/images/blog-img-1.jpg" alt="" class="img-fluid rounded w-100" />
                                </div>
                            </a>
                        </div>
                        <!-- text -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        <div class="mb-4">
                            <a href="#!">
                                <div class="img-zoom">
                                    <!-- img -->
                                    <img src="/fresh/images/blog-img-2.jpg" alt="" class="img-fluid rounded w-100" />
                                </div>
                            </a>
                        </div>
                        <!-- text -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        <div class="mb-4">
                            <a href="#!">
                                <!-- img -->
                                <div class="img-zoom">
                                    <img src="/fresh/images/blog-img-3.jpg" alt="" class="img-fluid rounded w-100" />
                                </div>
                            </a>
                        </div>
                        <!-- text -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-8">
                        <div class="mb-4">
                            <a href="#!">
                                <!-- img -->
                                <div class="img-zoom">
                                    <img src="/fresh/images/blog-img-4.jpg" alt="" class="img-fluid rounded w-100" />
                                </div>
                            </a>
                        </div>
                        <div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product productModal" id="productModal">
                                <div class="zoom" onmousemove="zoom(event)" style="background-image: url(/fresh/images/product-single-img-1.jpg)">
                                    <!-- img -->
                                    <img src="/fresh/images/product-single-img-1.jpg" alt="" />
                                </div>
                                <div>
                                    <div class="zoom" onmousemove="zoom(event)" style="background-image: url(/fresh/images/product-single-img-2.jpg)">
                                        <!-- img -->
                                        <img src="/fresh/images/product-single-img-2.jpg" alt="" />
                                    </div>
                                </div>
                                <div>
                                    <div class="zoom" onmousemove="zoom(event)" style="background-image: url(/fresh/images/product-single-img-3.jpg)">
                                        <!-- img -->
                                        <img src="/fresh/images/product-single-img-3.jpg" alt="" />
                                    </div>
                                </div>
                                <div>
                                    <div class="zoom" onmousemove="zoom(event)" style="background-image: url(/fresh/images/product-single-img-4.jpg)">
                                        <!-- img -->
                                        <img src="/fresh/images/product-single-img-4.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                            <!-- product tools -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-8 col-md-12 col-lg-4">
                    <a href="#"><img src="/fresh/images/freshcart-white-logo.svg" alt="" /></a>
                </div>
                ...
                <div class="row gy-4 align-items-center">
                    ...
                    <div class="col-lg-6 text-end mb-2 mb-lg-0">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                <a href="#!"><img src="/fresh/images/amazonpay.svg" alt="" /></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="/fresh/images/american-express.svg" alt="" /></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="/fresh/images/mastercard.svg" alt="" /></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="/fresh/images/paypal.svg" alt="" /></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="/fresh/images/visa.svg" alt="" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script src="/fresh/js/jquery.min.js"></script>

    <script src="/fresh/js/bootstrap.bundle.min.js"></script>
    <script src="/fresh/js/simplebar.min.js"></script>

    <script src="/fresh/js/theme.min.js"></script>

    <script src="/fresh/js/slick.min.js"></script>
    <script src="/fresh/js/slick-slider.js"></script>
    <script src="/fresh/js/tiny-slider.js"></script>
    <script src="/fresh/js/tns-slider.js"></script>
    <script src="/fresh/js/zoom.js"></script>
</body>
